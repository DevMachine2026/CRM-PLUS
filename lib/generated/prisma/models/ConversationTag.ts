...
export type ConversationTagWhereInput = {
  ...
  conversationId?: Prisma.UuidFilter<"ConversationTag"> | string
  tagId?: Prisma.UuidFilter<"ConversationTag"> | string
...
export type ConversationTagScalarWhereWithAggregatesInput = {
  ...
  conversationId?: Prisma.UuidWithAggregatesFilter<"ConversationTag"> | string
  tagId?: Prisma.UuidWithAggregatesFilter<"ConversationTag"> | string
...
export type ConversationTagOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"conversationId" | "tagId" | "createdAt", ExtArgs["result"]["conversationTag"]>
...
export interface ConversationTagDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const conversationTagWithConversationIdOnly = await prisma.conversationTag.findMany({ select: { conversationId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ConversationTags and only return the `conversationId`
   * const conversationTagWithConversationIdOnly = await prisma.conversationTag.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more ConversationTags and only return the `conversationId`
   * const conversationTagWithConversationIdOnly = await prisma.conversationTag.updateManyAndReturn({
   *   select: { conversationId: true },
   *   where: {
   *     // ... provide filter here
   *   },
